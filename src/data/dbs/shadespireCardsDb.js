const shadespireCardsDb = {
    ...
    "01018": {
        ...
        type: 1,
        rule:
            "Reaction: Play this after an Attack action or ploy that takes your last surviving fighter out of action. Roll a defense dice. If you roll a Shield or Critical Hit remove all wound tokens from them, and place them on a starting hex in your territory",
        set: 0,
        faq: "",
    },
    "01019": {
    ...
    "01022": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 1 Targets adjacent enemy fighters - roll for each",
        set: 0,
        faq: "-",
    },
    "01023": {
    ...
    "01029": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 2 If you roll at least one Critical Hit this Attack action has Cleave",
        set: 0,
        faq: "-",
    },
    "01030": {
    ...
    "01051": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 2 Roll an extra attack dice if there are no adjacent friendly fighters",
        set: 0,
        faq: "-",
    },
    "01052": {
        ...
        type: 2,
        rule:
            "Reaction: During an Attack action that targets this fighter and fails, roll an attack dice. On a roll of Hammer or Critical Hit this fighter cannot be driven back and they can make an Attack action. It must target the attacker.",
        set: 0,
        faq: "",
    },
    "01053": {
    ...
    "01055": {
        ...
        type: 2,
        rule:
            "Hex 2 Hammer 2 Damage 1 On a critical hit, this Attack action has +1 Damage",
        set: 0,
        faq: "-",
    },
    "01056": {
    ...
    "01057": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 3 Damage 2 Reaction: After this Attack action, if it failed and the target was an enemy leader, make this Attack action again",
        set: 0,
        faq: "-",
    },
    "01058": {
    ...
    "01081": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 2 Reaction: Make this Attack action during an Attack action that takes this fighter out of action, before they are removed from the battlefield. It must target their attacker",
        set: 1,
        faq: "-",
    },
    "01082": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 2 If you roll at least one Critical Hit this Attack action has Cleave",
        set: 1,
        faq: "-",
    },
    "01083": {
    ...
    "01102": {
        ...
        type: 1,
        rule:
            "Reaction: Play this during an Attack action or ploy that will take a friendly fighter out of action, before removing them from the battlefield. Roll an attack dice. On a roll of Hammer or Critical Hit make an Attack action with that fighter. It must target the attacker",
        set: 2,
        faq: "-",
    },
    "01103": {
    ...
    "01110": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 2 Targets all adjacent enemy fighters - roll for each",
        set: 2,
        faq: "-",
    },
    "01111": {
    ...
    "01113": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 2 If this Attack action succeeds, the target cannot be activated for the rest of the phase",
        set: 2,
        faq: "-",
    },
    "01114": {
    ...
    "01138": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 1 Reaction: During an Attack action that succeeds against this fighter, this fighter cannot be driven back and makes this Attack action. It must target the attacker.",
        set: 3,
        faq: "-",
    },
    "01139": {
    ...
    "01140": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 2 Damage 2 Targets all adjacent enemy fighters - roll for each",
        set: 3,
        faq: "-",
    },
    "01141": {
    ...
    "01144": {
        ...
        type: 2,
        rule:
            "Hex 3 Sword 2 Damage 1 On a critical hit this Attack action has +1 Damage",
        set: 3,
        faq: "-",
    },
    "01145": {
    ...
    "01172": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 1 Targets all adjacent enemy fighters - roll for each",
        set: 4,
        faq: "-",
    },
    "01173": {
    ...
    "01195": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 2 Damage 3 If this Attack action succeeds, remove one wound token from this fighter",
        set: 5,
        faq: "-",
    },
    "01196": {
    ...
    "01324": {
        ...
        type: 1,
        rule:
            "Reaction: Play this when an opponent plays a ploy. Roll a defence dice. On a roll of Shield or Critical Hit that ploy has no effect",
        set: 1,
        faq: "",
    },
    "01325": {
    ...
    "01343": {
        ...
        type: 1,
        rule:
            "Reaction: Play this after an Attack action or ploy that damage a friendly fighter. Push them up to one hex and make an Attack action with them",
        set: 5,
        faq: "-",
    },
    "01344": {
    ...
    "01345": {
        ...
        type: 1,
        rule:
            "Reaction: Play this during an Attack action or ploy that would take a friendly fighter out of action, when there is a friendly fighter adjacent to them. Roll a defence dice. On a roll of Shield or Critical Hit the fighter does not suffer damage and is not taken out of action",
        set: 2,
        faq: "-",
    },
    "01346": {
    ...
    "01349": {
        ...
        type: 1,
        rule:
            "Reaction: Play this during an enemy Attack action that would succeed. Roll a defence dice. On a roll of Dodge or Critical Hit the attacker suffers the damage, rather than the target, and neither fighter is driven back",
        set: 4,
        faq: "-",
    },
    "01350": {
    ...
    "01379": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 2 Damage 2 When making this Attack action, roll an extra attack dice for each other friendly fighter adjacent to the target",
        set: 1,
        faq: "-",
    },
    "01380": {
    ...
    "01382": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 3 Each time this fighter makes this Attack action, they first suffer 1 damage",
        set: 2,
        faq: "",
    },
    "01383": {
    ...
    "01385": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 1 Reaction: After this Attack action, if it is successful, you can push this fighter one hex",
        set: 0,
        faq: "-",
        copies: 2,
    },
    ...
    "01388": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 1 When rolling defence dice, only rolls of Crit are successes for the target of this Attack action. This Attack action can never cause more than 1 damage to a target",
        set: 5,
        faq: "-",
    },
    "01389": {
    ...
    "01405": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 1 Both Swordand Hammer symbols are successes for this Attack action",
        set: 2,
        faq: "-",
    },
    "01406": {
    ...
    "01409": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 2 When this Attack action is successful, discard this upgrade. On a critical hit, this Attack action has +1 Damage Hex 3 Hammer 2 Damage 2 After a fighter makes this Attack action, discard this upgrade. On a critical hit, this Attack action has +1 Damage",
        set: 3,
        faq: "-",
    },
    "01410": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 3 When this Attack action is successful, discard this upgrade. On a critical hit, this Attack action has +1 Damage",
        set: 5,
        faq: "-",
    },
    "01411": {
        ...
        type: 2,
        rule:
            "Hex 3 Sword 3 Damage 1 On a critical hit, this Attack action has +1 Damage",
        set: 2,
        faq: "-",
    },
    "01412": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 2 Damage 3 When this Attack action is successful, discard this upgrade. On a critical hit, this Attack action has +1 Damage",
        set: 4,
        faq: "-",
    },
    "01413": {
        ...
        type: 2,
        rule:
            "Hex 2 Hammer 2 Damage 2 When this Attack action is successful, discard this upgrade. On a critical hit, this Attack action has +1 Damage",
        set: 6,
        faq: "-",
    },
    "01414": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 3 Damage 2 When this Attack action is successful, discard this upgrade. On a critical hit, this Attack action has +1 Damage",
        set: 1,
        faq: "-",
    },
    "01415": {
    ...
    "01417": {
        ...
        type: 2,
        rule:
            "Reaction: After any Attack action in which you roll a Critical Hit for this fighter (with an attack or defence dice), you can push this fighter one hex",
        set: 3,
        faq: "-",
    },
    "01418": {
    ...
    "01423": {
        ...
        type: 2,
        rule:
            "Hex 1 Sword 3 Damage 1 Reaction: Before making this Attack action, push this fighter one hex",
        set: 2,
        faq: "",
    },
    "01424": {
        ...
        type: 2,
        rule:
            "Reaction: During an Attack action or ploy that takes this fighter out of action, roll a defence dice. If you roll a Shield or Critical Hit place them on any starting hex in your territory, ignore the damage and discard this upgrade. If you cannot, they are taken out of action",
        set: 5,
        faq: "-",
    },
    "01425": {
    ...
    "01434": {
        ...
        type: 2,
        rule:
            "Hex 1 Hammer 1 Damage 2 Rolls of Hammer are considered to be rolls of Critical Hit for this Attack action",
        set: 5,
        faq: "-",
    },
    "01435": {
...
export default shadespireCardsDb;
