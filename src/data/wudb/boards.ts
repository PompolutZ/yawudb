export const boards: Record<number, { name: string; location: string }> = {
    1: {
        name: "Mirror Well",
        location:
    ...
    8: { name: "Ruptured Seal", location: "Found in the Nightvault Core Box." },
    9: {
    ...
    14: { name: "Living Rock", location: "Found in the Beastgrave Core Box." },
    15: {
        name: "Shrine of the Silent People",
        location: "Found in the Beastgrave Core Box.",
    },
    16: { name: "Wyrmgrave", location: "Found in the Beastgrave Core Box." },
    17: {
    ...
    21: { name: "Pool of Fangs", location: "Found in the Direchasm Core Box." },
    22: {
    ...
    34: { name: "Visceral Coil", location: "Found in the Gnarlwood Core Box." },
    35: {
        name: "Stricken Swamp",
        location: "Found in the Gnarlwood Core Box.",
    },
