...
const DeckThumbnailHeader = ({
    ...
    <div className={classes.root}>
        <Typography variant="subtitle2" noWrap style={{ maxWidth: "18rem" }}>
            {title}
        </Typography>
        ...
        <div style={{ marginBottom: ".2rem" }}>
            ...
            {isDraft && (
                <div style={{ fontStyle: "italic", color: "darkorange" }}>
                    Draft
                </div>
            )}
        </div>
        <SetsList sets={sets} />
        <ScoringOverview
            summary={scoringOverview.summary}
            glory={scoringOverview.glory}
        />
    </div>
);
