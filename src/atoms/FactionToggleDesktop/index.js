        ...
        <div style={{ display: 'flex', marginRight: '1rem' }}>
            <div className={classes.selectedFaction}>
                <img
                    ...
                    height="72"
                />
                <Typography className={classes.selectedFactionName}>{factions[strippedFaction]}</Typography>
            </div>
            <div>
                <div>
                    ...
                    {warbandsWithDefaultSet
                        ...
                        .map(([f, defaultCardsSet]) => (
                            <FactionIcon key={f} faction={f} selected={f === selectedFaction[0]} onSelected={setSelectedFaction} cardsSet={defaultCardsSet} />
                        ))}
                </div>
                <div>
