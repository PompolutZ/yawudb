...
export default function usePublicDecksSyncronization() {
    const [lastLogTimestamp, setLastLogTimestamp] = useStateWithLocalStorage(
        "wunderworlds_lastpublog",
        undefined
    );
            ...
            firebase.realdb
                ...
                .then((s) => {
                    ...
                    firebase.realdb
                        ...
                        .once("value")
                        .then(async (s) => {
                            const flattened = Object.entries(s.val())
                                .map(([timestamp, value]) => ({
                                    ...value,
                                    timestamp: Number(timestamp),
                                }))
