...
class SecretDeckUploader extends Component {
    state = {
        ...
        scoringSummary:
            JSON.parse(localStorage.getItem("sdb.scoringSummary")) || [],
    ...
    handleChangeCardsList = (list) => {
        ...
        const objectiveScoringSummary = result
            .map((x) => {
        ...
        localStorage.setItem(
            "sdb.scoringSummary",
            JSON.stringify(objectiveScoringSummary)
        );
    ...
    handleSave = () => {
        ...
        const deckId = `${factionIdPrefix[this.state.faction]}-${uuid4().slice(
            -12
        )}`;
        const deckPayload = {
        ...
        return (
            ...
            >
                ...
                <TextField
                    ...
                    style={{ flex: "1 1 auto" }}
                    onChange={(e) =>
                        this.handleChangeDescription(e.target.value)
                    }
                />
