            ...
            <div className={classes.root}>
                {
                    !this.state.emailSent && (
                        <React.Fragment>
                            ...
                            <Button className={classes.button} onClick={this.handleClick}>Request password reset</Button>
                ...
                }
                {
                    this.state.emailSent && (
                        <React.Fragment>
                            <div style={{ margin: '5rem auto 1rem auto'}}>Email with a link to reset your password has been sent.</div>
                            <div style={{ margin: '0 auto 5rem auto'}}>Back to the gates in {this.state.redirectCountdown} seconds...</div>
                        </React.Fragment>
                    )
                }
            </div>
