...
const DeckCreatorNew = (props) => (
    <DeckCreatorBase {...props} editMode={false} transferMode={false} />
);
...
export default connect(mapStateToProps, mapDispatchToProps)(DeckCreatorNew);
