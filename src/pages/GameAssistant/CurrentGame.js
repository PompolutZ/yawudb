...
function CurrentGame(props) {
    ...
    useEffect(() => {
        ...
        setObjectivesDrawPile(
            shuffle(
                props.location.state.cards.filter((card) => card.type === 0)
            )
        );
        setPowersDrawPile(
            shuffle(
    ...
    useEffect(() => {}, [objectivesDrawPile]);

    useEffect(() => {}, [powersDrawPile]);
        ...
        <div className={classes.root}>
            ...
            <div style={{ flex: "1 100%", flexFlow: "row nowrap" }}>
                ...
                <div>
                    ...
                    <div className={classes.hand}>
                        {objectivesHand &&
                            Object.entries(objectivesHand).map(([id, card]) => (
                                <img
            ...
            >
                ...
                <DialogContent>
                    {cardToView && (
                        <img
                            src={`/assets/cards/${cardToView.id}.png`}
                            style={{ width: "100%" }}
                        />
                    )}
                </DialogContent>
