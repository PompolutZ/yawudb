...
class Icon extends PureComponent {
    ...
    render() {
        ...
        return (
            <ButtonBase className={classnames(classes.button, {[classes.selectedButton]: this.props.selectedIcon === this.props.icon})} 
                onClick={this.handleClick}>
                {
                    this.props.selectedIcon === this.props.icon &&  (
                        <img src={`/assets/icons/${this.props.icon}.png`} 
                            alt={this.props.icon} 
                ...
                {
                    this.props.selectedIcon !== this.props.icon &&  (
                        <img src={`/assets/icons/${this.props.icon}-bw.png`} 
                            alt={this.props.icon} 
...
class AvatarPicker extends PureComponent {
    state = {
        selectedIcon: this.props.defaultAvatar ? (this.props.defaultAvatar.split('/')[3]).split('.')[0] : factionIndexes[1] + '-icon',
