...
const SelectedFaction = ({ faction, style }) => (
    ...
    >
        ...
        <Typography variant="body1">{`${
            faction.startsWith("n_")
                ? factions[faction.slice(2)]
                : factions[faction]
        }`}</Typography>
    </div>
);
...
class FactionToggle extends Component {
    ...
    handleSelectFaction = (faction, defaultSet) => {
        ...
        this.timeoutId = setTimeout(
            () => this.props.setFaction(faction, defaultSet),
            250
        );
    };
        ...
        return (
            ...
            >
                <ToggleImageButton
                    ...
                    onImage={`/assets/icons/${
                        faction.startsWith("n_") ? faction.slice(2) : faction
                    }-icon.png`}
                    offImage={`/assets/icons/${
                        faction.startsWith("n_") ? faction.slice(2) : faction
                    }-icon-bw.png`}
                    onToggle={this.handleSelectFaction.bind(
                        this,
                        faction,
                        defaultSet
                    )}
    ...
    render() {
        ...
        return (
            <div className={classes.root}>
                ...
                <AnimateHeight duration={200} easing="ease-out" height={height}>
                    <div
                        style={{
                            display: "flex",
                    ...
                    >
                        ...
                        {warbandsWithDefaultSet
                            ...
                            .map(([faction, defaultSet]) =>
                                this.renderFactionToggleButton(
                                    faction,
                                    defaultSet
                                )
                            )}
